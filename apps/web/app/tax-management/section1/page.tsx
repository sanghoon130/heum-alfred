...
export default function Section1() {
  ...
  return (
    <>
    {/* Mobile */}
        <div className="md:hidden w-full box-border bg-[#2F2F2F] pt-[24px] relative h-auto">
        <div 
          ...
          <div className="box-border mx-auto w-[307px] mt-[62px] flex flex-col items-center gap-[16px]">
            ...
            <h3 className="text-[#FFFFFF] text-[32px] font-[700] leading-[138%] tracking-[-0.64spx]">세무 관리</h3>
            <div className="text-[#FFFFFF] text-center text-[20px] font-[400] leading-[156%] tracking-[-0.4px]">국세부터 지방세 등 각종 세금 납부 기한 안내와 즉시 납부까지, 사업에 필요한 각종 증명서 발급도 연동 한 번으로 간편하게</div>
            <div className={`mt-2 px-6 py-3 w-[176px] h-[48px] box-border flex gap-[4px] justify-center items-center bg-[#0F65BA] hover:bg-[#0C5195] rounded-[12px] transition-colors duration-300 ease-in-out`}>
          ...
          <Image src="/images/Section1_BG.png" alt="section1" width={319} height={292} className="w-full pl-[21px] pb-[26px] aspect-[319/292] box-border mt-[56px]"/>
    ...
    {/* Tablet */}
      ...
      >
        ...
        <div className="w-[448px] box-border mx-auto mt-[122px] flex flex-col items-center gap-[16px]">
          ...
          <h3 className="text-[#FFFFFF] text-[48px] font-[700] leading-[138%] text-center tracking-[-0.96px]">
            세무 관리
          </h3>
          <div className="text-[#FFFFFF] text-[20px] font-[400] leading-[156%] text-center tracking-[-0.4px]">
            국세, 지방세 등 각종 세금 납부 기한 안내와 <br /> 즉시 납부까지,
            
            사업에 필요한 각종 증명서 발급도 <br /> 연동 한 번으로 간편하게
          </div>
          <div
            className={`mt-2 px-6 py-3 w-[176px] h-[48px] box-border flex gap-[4px] justify-center items-center bg-[#0F65BA] hover:bg-[#0C5195] rounded-[12px] transition-colors duration-300 ease-in-out`}
          >
      ...
      {/* Desktop */}
      <div
        className="w-full box-border hidden xl:block bg-[#2F2F2F] pt-[30px] relative"
      ...
      >
        ...
        <Image
          src="/images/TAXMAN_Section1_BG.png"
          alt="section1"
          width={799}
          height={619}
        ...
        >
          ...
          <h3 className="text-[#FFFFFF] text-[64px] font-[700] leading-[138%] tracking-[-1.28px]">
            세무 관리
          </h3>
          <div className="text-[#FFFFFF] text-[20px] font-[400] leading-[156%] tracking-[-0.4px]">
            국세부터 지방세 등 각종 세금 납부 기한 안내와 즉시 납부까지, 사업에
            필요한 각종 증명서 발급도 연동 한 번으로 간편하게
          </div>
          <div
            className={`mt-8 px-6 py-3 w-[176px] h-[48px] box-border flex gap-[4px] items-center bg-[#0F65BA] hover:bg-[#0C5195] rounded-[12px] transition-colors duration-300 ease-in-out`}
          >
            <div className="text-[#FFFFFF] text-[14px] font-[700] leading-[120%] tracking-[-0.168px] ">
              무료 버전 체험하기
            </div>
