    ...
    <>
      ...
      <section className="md:hidden w-full box-border bg-[#2F2F2F] pt-[24px] relative h-auto">
        ...
        <div className="box-border mx-auto w-[307px] mt-[62px] flex flex-col items-center gap-[16px]">
          ...
          <div
            className={`mt-2 px-6 py-3 w-[176px] h-[48px] box-border flex gap-[4px] justify-center items-center bg-[#1D805F] hover:bg-[#17664C] rounded-[12px] transition-colors duration-300 ease-in-out`}
          >
      ...
      >
        ...
        <Image
          src="/images/HR_Section1_BG_Tab.png"
          alt="section1"
          width={710}
          height={433}
          className="w-[710px] h-[433px] absolute bottom-0 left-1/2 -translate-x-1/2"
        />
      </section>
      {/* Desktop */}
      <section
      ...
      >
        ...
        >
          ...
          <div
            className={`mt-8 px-6 py-3 w-[176px] h-[48px] box-border flex gap-[4px] justify-center items-center bg-[#1D805F] hover:bg-[#17664C] rounded-[12px] transition-colors duration-300 ease-in-out`}
          >
            <div className="text-[#FFFFFF] text-[14px] font-[700] leading-[120%] tracking-[-0.168px] ">
              무료 버전 체험하기
            </div>
