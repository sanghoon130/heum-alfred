    ...
    <>
      ...
      <section className="md:hidden w-full box-border bg-[#2F2F2F] pt-[24px] relative h-auto">
        ...
        <div className="box-border mx-auto w-[307px] mt-[62px] flex flex-col items-center gap-[16px]">
          ...
          <h1 className="text-[#FFFFFF] text-[32px] font-[700] leading-[138%] tracking-[-0.64spx]">
            사업 현황 보고서
          </h1>
          <div className="text-[#FFFFFF] text-center text-[20px] font-[400] leading-[156%] tracking-[-0.4px]">
            세무, 급여, 재무 현황까지,
            <br />
            사업 현황 파악에 꼭 필요한
            <br />
          ...
          <div
            className={`mt-2 px-6 py-3 w-[176px] h-[48px] box-border flex gap-[4px] justify-center items-center bg-[#E37617] hover:bg-[#B65E12] rounded-[12px] transition-colors duration-300 ease-in-out`}
          >
        ...
        <Image
          src="/images/Section1_BG.png"
          alt="section1"
          width={319}
          height={292}
          className="w-full pl-[21px] pb-[26px] aspect-[319/292] box-border mt-[56px]"
        />
      </section>
      ...
      >
        ...
        <div className="w-[448px] box-border mx-auto mt-[122px] flex flex-col items-center gap-[16px]">
          ...
          <h1 className="text-[#FFFFFF] text-[48px] font-[700] leading-[138%] tracking-[-0.96px]">
            사업 현황 보고서
          </h1>
          <div className="text-[#FFFFFF] text-[20px] font-[400] leading-[156%] tracking-[-0.4px]">
            세무, 급여, 재무 현황까지, 사업 현황 파악에
            <br />꼭 필요한 주요 지표들을 보고서로 간편하게
          </div>
          <div
            className={`mt-2 px-6 py-3 w-[176px] h-[48px] box-border flex gap-[4px] justify-center items-center bg-[#E37617] hover:bg-[#B65E12] rounded-[12px] transition-colors duration-300 ease-in-out`}
          >
        ...
        <Image
          src="/images/Section1_BG_Tab.png"
          alt="section1"
          width={721}
          height={433}
          className="w-[721px] h-[433px] absolute bottom-0 left-1/2 -translate-x-1/2"
        />
      </section>
      ...
      >
        ...
        >
          ...
          <div
            className={`mt-8 px-6 py-3 w-[176px] h-[48px] box-border flex gap-[4px] items-center bg-[#E37617] hover:bg-[#B65E12] rounded-[12px] transition-colors duration-300 ease-in-out`}
          >
            <div className="text-[#FFFFFF] text-[14px] font-[700] leading-[120%] tracking-[-0.168px] ">
              무료 버전 체험하기
            </div>
